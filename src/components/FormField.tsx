    ...
    <label className="group block text-left">
      ...
      <span className="relative block">
        ...
        {options ? (
          <select
            defaultValue=""
            className="h-14 w-full appearance-none rounded-lg border border-white/10 bg-nexa-deep/70 px-12 text-sm text-white/80 outline-none transition placeholder:text-white/38 focus:border-nexa-violet/70 focus:shadow-[0_0_24px_rgba(174,60,255,0.24)]"
          >
          ...
          <input
            ...
            className={cn(
              'h-14 w-full rounded-lg border border-white/10 bg-nexa-deep/70 px-12 text-sm text-white outline-none transition placeholder:text-white/38',
